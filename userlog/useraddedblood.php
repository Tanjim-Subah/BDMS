...
<body>
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
							...
							if(isset($_POST['name'])){
								...
								$previous_donation = $_POST["previous_donation"];
    ...
    $previousDate = new DateTime($previousDonation);
    $newDate = new DateTime($newDonation);
    $interval = $previousDate->diff($newDate);
    $diffDays = $interval->days;

    // Check if the difference is less than 90 days
    if ($diffDays < 90) {
        echo "<script>alert('You must wait at least 3 months between donations.'); window.history.back();</script>";
        exit();
    }
								...
								$qry = "insert into blood(name,gender,dob,weight,bloodgroup,address,contact,bloodqty,previous_donation, new_donation) values ('$name','$gender','$dob','$weight','$bloodgroup','$address','$contact','$bloodqty','$previous_donation', '$new_donation')";
