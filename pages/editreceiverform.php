...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Edit Receiver's Detail</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
...
$id=$_GET['id'];
$qry= "select * from receiver where id='$id'";
$result=mysqli_query($conn,$qry);
while($row=mysqli_fetch_array($result)){
    
?>                                    
                                    <form role="form" action="editrec.php" method="post"onsubmit= "return validateForm()">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="text" name="medicalcondition" value='<?php echo $row['medicalcondition']; ?>' required>
                                        </div>
