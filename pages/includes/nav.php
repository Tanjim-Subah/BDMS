...
<nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="addblood.php"><i class="fa fa-table fa-user-plus"></i> Add Blood</a>
                                </li>
                                <li>
                                    <a href="viewblood.php"><i class="fa fa-edit fa-eye"></i> View Blood</a>
                                </li>
                        ...
                        <li>
                            <a href=""><i class="fa fa-heartbeat"></i> Donor's Details <span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                              <li>
                    ...
                    <!--    <li>
                            <a href=""><i class="fa fa-heartbeat"></i> Reciever's Details <span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                              <li>
                                <a href="addreceiver.php"><i class="fa fa-table fa-user-plus"></i> Add Reciever </a>
                            </li>
                             <li>
                            <a href="viewreceiver.php"><i class="fa fa-edit fa-eye"></i> View Reciever Details</a>
                        </li>
                    </ul>
                </li>-->
